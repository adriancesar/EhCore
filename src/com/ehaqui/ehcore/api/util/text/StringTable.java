package com.ehaqui.ehcore.api.util.text;

import java.util.ArrayList;

import org.bukkit.ChatColor;

import com.ehaqui.ehcore.api.message.ColourLoop;
...
public class StringTable
{
    ...
    private Double getColumnWidth(int i)
    {
        ...
        if(customWidths == null || i >= customWidths.size() || i < 0)
            return StringFiller.CHAT_WIDTH / table.size();
     ...
     *            column index
     */
    public void addLine(String value1, boolean value2, Integer index)
    {
        ...
        addLine(value1, index);
        addLine(color + String.valueOf(value2), index + 1);
     ...
     *            column index
     */
    public void addLine(String value1, int value2, Integer index)
    {
        
        addLine(value1, index);
        addLine(String.valueOf(value2), index + 1);
