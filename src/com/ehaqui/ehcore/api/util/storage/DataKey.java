...
public abstract class DataKey
{
    ...
    {
        if(keyExists(key)) return getBoolean(key);
    ...
    {
        if(keyExists(key)) return getDouble(key);
        setDouble(key, value);
        return value;
    }
    ...
    {
        if(keyExists(key)) return getInt(key);
        setInt(key, value);
        return value;
    }
    ...
    {
        if(keyExists(key)) return getLong(key);
        setLong(key, value);
        return value;
    }
    ...
    {
        if(keyExists(key)) return getString(key);
        setString(key, value);
        return value;
    }
