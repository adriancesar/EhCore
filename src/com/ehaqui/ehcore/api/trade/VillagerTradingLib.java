...
public class VillagerTradingLib
{
     ...
     * 
     * @param player
     *            - The player to open a trading window with
     * @param offers
     *            - The trades that are being offered
    ...
    public void OpenTrade(Player player, VillagerTradeOffer[] offers) throws NullTradeOfferException, IOException
    {
        ...
        p.playerConnection.sendPacket(tradeWindow);
        p.playerConnection.sendPacket(getVillagerOfferPacket(list, windowId));
    }
    
    /**
     * 
     * @param list
     *            - A list of trade recipe's
     * @param windowID
     *            - Id of the window that this affects
     ...
     * 
     * @param offers
     *            - An array of VillagerTradeOffers to be added to the list
